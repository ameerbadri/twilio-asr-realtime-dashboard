  ...
  render() {
    const _props = this.props,
      ...
      theme
          ...
          other = _objectWithoutProperties(_props, ['appear', 'children', 'classes', 'className', 'component', 'collapsedHeight', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'style', 'timeout', 'theme']);

...
<html lang="en">
  ...
  <script type="text/javascript">
      ...
      //some test JSON
      var test_json = {
          test: 'click me to expand. I set the `collapseStringsAfterLength` prop to 18 to collapse strings longer than 18 characters.  You can click me again to collapse.',
          another_sibling: 42,
